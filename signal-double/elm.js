...
Elm.Main.make = function (_elm) {
   ...
   var view = function (x) {
      var doubleTxt = $Basics.toString($double(x));
      var text = A2($Basics._op["++"],$Basics.toString(x),A2($Basics._op["++"]," | ",doubleTxt));
      return $Html.text(text);
   };
   var main = A2($Signal.map,view,$Mouse.x);
   return _elm.Main.values = {_op: _op,view: view,$double: $double,main: main};
};
